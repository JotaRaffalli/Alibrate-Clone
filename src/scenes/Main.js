    ...
    render(){
        return(
            <View style={styles.container}>
                <Text>Bienvenido {this.props.userData.userInfo.profile.displayName}</Text>
                <Text>{this.props.isLogged ? "Hola": this.props.isLogged.toString()}</Text>
            <Profile {...contactData}></Profile>
                <Button
                    onPress={ () => { console.log(this.props.userData);this.props.logout() } }
                    title={"Salir"}
                />
            </View>
        )
